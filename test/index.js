...
describe('API ENDPOINT TESTING', () => {
    it('GET Landing Page', (done) => {
        chai.request(app).get('/api/v1/member/landing-page').end((err, res) => {
            ...
            expect(res.body.hero).to.have.all.keys('traveler', 'treasures', 'cities')
    ...
    it('GET Detail Page', (done) => {
        chai.request(app).get('/api/v1/member/detail-page/5e96cbe292b97300fc902223').end((err, res) => {
            ...
            expect(res.body.imageId).to.have.have.an('array')
            expect(res.body).to.have.property('featureId')
            expect(res.body.featureId).to.have.have.an('array')
            expect(res.body).to.have.property('activityId')
            expect(res.body.activityId).to.have.have.an('array')
            ...
            expect(res.body.bank).to.have.have.an('array')
            expect(res.body).to.have.property('testimonial')
            expect(res.body.testimonial).to.have.an('object')
            done();
        })
    ...
    it('POST Booking Page', (done) => {
        ...
        const dataSample = {
            ...
            duration: '2',
            bookingStartDate: '9-7-2021',
            bookingEndDate: '11-7-2021',
            firstName: 'Rifki',
            lastName: 'Oskar',
            email: 'rifkioskar@gmail.com',
            phoneNumber: '0812123456789',
            accountHolder: 'rifki',
            bankFrom: 'BNI',
        }
        chai.request(app).post('/api/v1/member/booking-page')
            ...
            .end((err, res) => {
                ...
                expect(res.body.messages).to.equal('Sukses Booking')
